...
- [ ] 68 — [A vocabulary of tactics, not one behaviour](68-a-vocabulary-of-tactics.md)

## Backlog

- [ ] 81 — [The live-brain picker is dead code](81-live-picker-cannot-name-attack-run.md)
