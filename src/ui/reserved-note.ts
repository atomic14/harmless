...
//
// Split out of `ui/screens.ts` by docs/TODO/149, and given its own file for the
// reason `portrait.ts` has one: two readers that are otherwise unrelated. The
// combat trainer's setup panel paints its help and brain notes through it, and
// the test-mode screen paints its one warning through it.
//
...
// markup keeps that much room whether the note is showing or not. A panel whose
// rows jump as you arrow down them is a panel you cannot read.
