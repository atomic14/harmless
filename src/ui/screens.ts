import { type StarSystem, type MarketEntry, ECONOMY_NAMES, GOVERNMENT_NAMES, COMMODITIES, speciesName } from '../galaxy/galaxy.ts';
...
import { type CommanderData, type Contract, cargoTonnes, consignedTonnes, formatCredits, cargoCapacity } from '../game/commander.ts';
