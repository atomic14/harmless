...
389 exported constants. Regenerate with `npm run generate:constants`;
...
| law | <code>OFFENDER</code> | <code>1</code> |  |  | [law.ts:47](./law.ts#L47) |
| law | <code>FUGITIVE</code> | <code>2</code> |  |  | [law.ts:48](./law.ts#L48) |
| law | <code>STATION_TRUCE</code> | <code>7000</code> | How close to the station the commander must be for the truce to hold. |  | [law.ts:75](./law.ts#L75) |
| law | <code>CONTRABAND</code> | <code>[3, 6, 10]</code> | The commodity indices that the Galactic Government defines as illegal: slaves, narcotics and firearms. |  | [law.ts:83](./law.ts#L83) |
| law | <code>OFFENDER_FINE</code> | <code>250</code> | The fine for a dock with a record, capped at what you can actually pay. |  | [law.ts:89](./law.ts#L89) |
| law | <code>FUGITIVE_FINE</code> | <code>750</code> |  |  | [law.ts:90](./law.ts#L90) |
| law | <code>KILLS_PER_RUNG</code> | <code>5</code> | Pirate kills that take a legal record down one rung. | <code>law.killsPerRung</code> | [law.ts:121](./law.ts#L121) |
| law | <code>DEFENCE_RANGE</code> | <code>9000</code> | Misbehave within this range of the station slot, and the Vipers launch. |  | [law.ts:129](./law.ts#L129) |
| law | <code>SCAN_RANGE</code> | <code>2600</code> | How close a police ship must be to scan your hold. |  | [law.ts:132](./law.ts#L132) |
| law | <code>SCAN_WARN_RANGE</code> | <code>4400</code> | A police ship this close is about to be able to read your hold, and the console says so while it stays there. |  | [law.ts:152](./law.ts#L152) |
| law | <code>SCAN_WARN_REPEAT</code> | <code>2</code> | Seconds between repeats of that warning, while a patrol stays in the band. | <code>law.scanWarnRepeat</code> | [law.ts:169](./law.ts#L169) |
| law | <code>BRIBE_SHARE</code> | <code>0.5</code> | What a policeman charges to not read your hold: this share of what the contraband aboard is worth at market. | <code>law.bribeShare</code> | [law.ts:198](./law.ts#L198) |
| law | <code>BRIBE_FLOOR</code> | <code>500</code> | ...but never less than this, so a light run is not a free pass. 50 Cr, in tenths of a credit (invariant 8). | <code>law.bribeFloor</code> | [law.ts:218](./law.ts#L218) |
| law | <code>PATROL_BRIBE_FINES</code> | <code>4</code> | What a police ship that already shoots at you charges to break off, as a multiple of the fine for the rung you are on. | <code>law.patrolBribeFines</code> | [law.ts:242](./law.ts#L242) |
| law | <code>BRIBE_REFUSED</code> | <code>0.35</code> | How often an HONEST commander's offer is refused and reported. | <code>law.bribeRefused</code> | [law.ts:274](./law.ts#L274) |
| law | <code>SCAN_LINE_SECONDS</code> | <code>4</code> | How long the scan's own line holds the console, and therefore how long the verdict that explains it waits behind it. | <code>law.scanLineSeconds</code> | [law.ts:289](./law.ts#L289) |
...
| spawn-placement | <code>STATION_DEFENCE_MIN</code> | <code>1</code> | The fewest Vipers the station launches after you shoot at something you should not. |  | [spawn-placement.ts:229](./spawn-placement.ts#L229) |
| spawn-placement | <code>STATION_DEFENCE_SPAN</code> | <code>2</code> | ...and the width of that draw: one or two of them. |  | [spawn-placement.ts:235](./spawn-placement.ts#L235) |
| spawn-placement | <code>STATION_DEFENCE_STANDOFF</code> | <code>500</code> | How far out of the slot the first one launches. |  | [spawn-placement.ts:241](./spawn-placement.ts#L241) |
| spawn-placement | <code>STATION_DEFENCE_STACK</code> | <code>120</code> | ...and how much further out each one after it starts, so a pair does not arrive inside each other. |  | [spawn-placement.ts:247](./spawn-placement.ts#L247) |
| spawn-placement | <code>STATION_DEFENCE_JITTER</code> | <code>80</code> | ...and the random nudge on each, so a second launch does not look like the first. |  | [spawn-placement.ts:257](./spawn-placement.ts#L257) |
