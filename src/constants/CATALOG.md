...
374 exported constants. Regenerate with `npm run generate:constants`;
...
| combat-computer | <code>TARGET_DIST_WEIGHT</code> | <code>800</code> | How many world units of range weigh as much as one radian of off-nose turn, when the co-pilot ranks targets by how easy they are to lock (`game/scripted-co-pilot.ts`). |  | [combat-computer.ts:190](./combat-computer.ts#L190) |
...
| combat-record | <code>MAX_SAMPLES</code> | <code>12_000</code> | Samples kept before the buffer closes. |  | [combat-record.ts:53](./combat-record.ts#L53) |
...
| docking | <code>TURN_IN</code> | <code>Math.PI / 4</code> | How far round from the slot axis an approach turns in, in radians. |  | [docking.ts:44](./docking.ts#L44) |
| docking | <code>RUN_IN_WIDTHS</code> | <code>GATE_HALF_WIDTHS * 0.6</code> | Where the approach stops the curve and flies straight, in station half-widths. |  | [docking.ts:77](./docking.ts#L77) |
| docking | <code>LINED_UP_LATERAL</code> | <code>45</code> | The off-axis error we insist on before we commit to the run in, in world units. |  | [docking.ts:88](./docking.ts#L88) |
| docking | <code>HULL_BOX_MARGIN</code> | <code>50</code> | The bounding cube around the station: a margin over the half-width, in world units, a little larger than the hull. |  | [docking.ts:100](./docking.ts#L100) |
| docking | <code>NPC_HULL_BOX_MARGIN</code> | <code>HULL_BOX_MARGIN</code> | The same cube for every NPC. |  | [docking.ts:105](./docking.ts#L105) |
| docking | <code>SLOT_HALF_ACROSS</code> | <code>26</code> | The slot channel, as half-extents ACROSS the slot and ALONG it, in station-local world units. |  | [docking.ts:113](./docking.ts#L113) |
| docking | <code>SLOT_HALF_ALONG</code> | <code>62</code> |  |  | [docking.ts:114](./docking.ts#L114) |
| docking | <code>SLOT_DEPTH</code> | <code>60</code> | How far into the -Z face counts as being in the channel, in world units. |  | [docking.ts:117](./docking.ts#L117) |
| docking | <code>ROLL_TOLERANCE</code> | <code>0.65</code> | The wings against the slot's long axis, in radians: how badly you may be rolled and still fit through the letterbox. |  | [docking.ts:128](./docking.ts#L128) |
| docking-computer | <code>DOCK_COMPUTER_RANGE</code> | <code>3500</code> | How close to the station the docking computer will take the job, in world units. |  | [docking-computer.ts:43](./docking-computer.ts#L43) |
| docking-computer | <code>DC_SLOT_MARGIN</code> | <code>0.30</code> | How much of the slot's roll tolerance the TURN may spend, as a fraction. | <code>docking.slotMargin</code> | [docking-computer.ts:89](./docking-computer.ts#L89) |
| docking-computer | <code>DC_TURN_FADE_ANGLE</code> | <code>0.10</code> | The off-nose angle, in radians, over which the TURN's claim on the roll axis ramps in. | <code>docking.turnFadeAngle</code> | [docking-computer.ts:139](./docking-computer.ts#L139) |
| docking-computer | <code>DC_ROLL_LEAD</code> | <code>0.10</code> | How far ahead IN TIME the roll ask reads the rate it already rolls at, in seconds. | <code>docking.rollLead</code> | [docking-computer.ts:195](./docking-computer.ts#L195) |
| docking-computer | <code>DC_PATH_LOOKAHEAD</code> | <code>1.5</code> | How far ahead ALONG THE PATH the follower aims, in station half-widths. | <code>docking.pathLookahead</code> | [docking-computer.ts:243](./docking-computer.ts#L243) |
...
| encounters | <code>AMBUSH_STANDOFF</code> | <code>7000</code> | A commander closer than this to the station is not worth an ambush. |  | [encounters.ts:116](./encounters.ts#L116) |
| encounters | <code>MAX_THARGONS</code> | <code>4</code> | How many drones one Thargoid mothership keeps in the sky. |  | [encounters.ts:123](./encounters.ts#L123) |
| encounters | <code>THARGON_REDEPLOY</code> | <code>5</code> | Seconds between one drone and the next, and the wait for the first. |  | [encounters.ts:132](./encounters.ts#L132) |
...
| hull-breach | <code>CARGO_LOSS_CHANCE</code> | <code>0.7</code> | Cargo is lost this often when there is any aboard. |  | [hull-breach.ts:24](./hull-breach.ts#L24) |
| hull-breach | <code>BREAKABLE</code> | <code>[ ['ecm', 'E.C.M. SYSTEM'], ['scoops', 'FUEL SCOOPS'], ['rearLaser', 'REAR LASER'], ['leftLaser', 'LEFT LASER'], ['rightLaser', 'RIGHT LASER'], ['dockingComputer', 'DOCKING COMPUTER'], ['combatComputer', 'COMBAT COMPUTER'], ] as const</code> | The fittings that a hull breach can knock out, in the order they are offered. |  | [hull-breach.ts:35](./hull-breach.ts#L35) |
...
| jump | <code>COUNTDOWN</code> | <code>5</code> | Seconds of warning before the drive engages. |  | [jump.ts:15](./jump.ts#L15) |
| jump | <code>JUMP_DAYS_BASE</code> | <code>1</code> | A jump takes this many days, plus one more per `TENTHS_PER_JUMP_DAY`. |  | [jump.ts:24](./jump.ts#L24) |
| jump | <code>TENTHS_PER_JUMP_DAY</code> | <code>20</code> | ...and that "one more per": 20 tenths, which is 2.0 light years a day. |  | [jump.ts:33](./jump.ts#L33) |
| jump | <code>WITCHSPACE_ESCAPE_COST</code> | <code>10</code> | Flat fuel cost of an escape from a mis-jump, in tenths of a LY. |  | [jump.ts:44](./jump.ts#L44) |
| jump | <code>MISJUMP_CHANCE</code> | <code>0.09</code> | The chance that a jump drops you into witch-space instead of at your destination. |  | [jump.ts:53](./jump.ts#L53) |
| jump | <code>MISJUMP_CHANCE_PLANS</code> | <code>0.22</code> | ...and the raised chance while you carry the Constrictor plans (mission stage 3, per `game/missions.ts`). |  | [jump.ts:60](./jump.ts#L60) |
...
| law | <code>CONTRABAND</code> | <code>[3, 6, 10]</code> | The commodity indices that the Galactic Government defines as illegal: slaves, narcotics and firearms. |  | [law.ts:35](./law.ts#L35) |
| law | <code>OFFENDER_FINE</code> | <code>250</code> | The fine for a dock with a record, capped at what you can actually pay. |  | [law.ts:41](./law.ts#L41) |
| law | <code>FUGITIVE_FINE</code> | <code>750</code> |  |  | [law.ts:42](./law.ts#L42) |
| law | <code>DEFENCE_RANGE</code> | <code>9000</code> | Misbehave within this range of the station slot, and the Vipers launch. |  | [law.ts:50](./law.ts#L50) |
| law | <code>SCAN_RANGE</code> | <code>2600</code> | How close a police ship must be to scan your hold. |  | [law.ts:53](./law.ts#L53) |
| law | <code>SCAN_WARN_RANGE</code> | <code>4400</code> | A police ship this close is about to be able to read your hold, and the console says so while it stays there. |  | [law.ts:73](./law.ts#L73) |
| law | <code>SCAN_WARN_REPEAT</code> | <code>2</code> | Seconds between repeats of that warning, while a patrol stays in the band. | <code>law.scanWarnRepeat</code> | [law.ts:90](./law.ts#L90) |
| law | <code>BRIBE_SHARE</code> | <code>0.5</code> | What a policeman charges to not read your hold: this share of what the contraband aboard is worth at market. | <code>law.bribeShare</code> | [law.ts:115](./law.ts#L115) |
| law | <code>BRIBE_FLOOR</code> | <code>500</code> | ...but never less than this, so a light run is not a free pass. 50 Cr, in tenths of a credit (invariant 8). | <code>law.bribeFloor</code> | [law.ts:135](./law.ts#L135) |
| law | <code>PATROL_BRIBE_FINES</code> | <code>4</code> | What a police ship that already shoots at you charges to break off, as a multiple of the fine for the rung you are on. | <code>law.patrolBribeFines</code> | [law.ts:159](./law.ts#L159) |
| law | <code>BRIBE_REFUSED</code> | <code>0.35</code> | How often an HONEST commander's offer is refused and reported. | <code>law.bribeRefused</code> | [law.ts:184](./law.ts#L184) |
| law | <code>SCAN_LINE_SECONDS</code> | <code>4</code> | How long the scan's own line holds the console, and therefore how long the verdict that explains it waits behind it. | <code>law.scanLineSeconds</code> | [law.ts:199](./law.ts#L199) |
...
| spawn-placement | <code>TRADER_SCATTER</code> | <code>1800</code> | How far from the station a trader on its run loiters. |  | [spawn-placement.ts:20](./spawn-placement.ts#L20) |
| spawn-placement | <code>POLICE_SCATTER</code> | <code>1200</code> | How far off the arrival corridor the police scatter. |  | [spawn-placement.ts:28](./spawn-placement.ts#L28) |
| spawn-placement | <code>POLICE_PATROL_RANGE</code> | <code>18_000</code> | How far a launch scatters the patrol across the system. |  | [spawn-placement.ts:36](./spawn-placement.ts#L36) |
| spawn-placement | <code>ASTEROID_SCATTER</code> | <code>5000</code> | How far the rocks scatter. |  | [spawn-placement.ts:43](./spawn-placement.ts#L43) |
| spawn-placement | <code>HUNTER_SCATTER</code> | <code>6000</code> | How far out a bounty hunter starts, at work on the whole system. |  | [spawn-placement.ts:51](./spawn-placement.ts#L51) |
| spawn-placement | <code>HERMIT_SCATTER</code> | <code>14_000</code> | How far out the rock hermit hides. |  | [spawn-placement.ts:58](./spawn-placement.ts#L58) |
| spawn-placement | <code>CORRIDOR_START</code> | <code>0.1</code> | Where along the route from you to the station the nearest pirate can be, as a fraction of that route. | <code>spawn.corridorStart</code> | [spawn-placement.ts:72](./spawn-placement.ts#L72) |
| spawn-placement | <code>CORRIDOR_SPAN</code> | <code>0.75</code> | How much of the route the rest are spread across. 0.1 + 0.75 leaves the last 15% clear, which is the approach to the station. |  | [spawn-placement.ts:78](./spawn-placement.ts#L78) |
| spawn-placement | <code>PIRATE_SCATTER</code> | <code>2500</code> | How far off the corridor's line each pirate sits. |  | [spawn-placement.ts:84](./spawn-placement.ts#L84) |
| spawn-placement | <code>TRADER_ARRIVAL_RANGE</code> | <code>22_000</code> | How far out a fresh trader warps in. |  | [spawn-placement.ts:91](./spawn-placement.ts#L91) |
| spawn-placement | <code>PIRATE_WAVE_RANGE</code> | <code>9000</code> | How far from the commander a pirate wave warps in. |  | [spawn-placement.ts:99](./spawn-placement.ts#L99) |
| spawn-placement | <code>PIRATE_WAVE_RANGE_SPAN</code> | <code>4000</code> | ...and how much further out than that they may be. |  | [spawn-placement.ts:102](./spawn-placement.ts#L102) |
| spawn-placement | <code>GENERATION_SHIP_RANGE</code> | <code>14_000</code> | How far from the commander a generation ship crosses. |  | [spawn-placement.ts:108](./spawn-placement.ts#L108) |
| spawn-placement | <code>GENERATION_SHIP_RANGE_SPAN</code> | <code>8000</code> | ...and the width of that band. |  | [spawn-placement.ts:111](./spawn-placement.ts#L111) |
| spawn-placement | <code>GENERATION_CARGO_SCATTER</code> | <code>700</code> | How far from a generation ship its shed cargo drifts. |  | [spawn-placement.ts:118](./spawn-placement.ts#L118) |
| spawn-placement | <code>MISSION_TARGET_RANGE</code> | <code>4000</code> | How far from the commander the Constrictor hides on the mission leg. |  | [spawn-placement.ts:124](./spawn-placement.ts#L124) |
| spawn-placement | <code>MISSION_TARGET_RANGE_SPAN</code> | <code>4000</code> | ...and the width of that band — the same again, so it can be twice as far. |  | [spawn-placement.ts:127](./spawn-placement.ts#L127) |
| spawn-placement | <code>THARGON_DEPLOY_RANGE</code> | <code>150</code> | How far from its mother a Thargon drone appears. |  | [spawn-placement.ts:133](./spawn-placement.ts#L133) |
| spawn-placement | <code>STATION_DEFENCE_MIN</code> | <code>1</code> | The fewest Vipers the station launches when you have shot at something you should not have. |  | [spawn-placement.ts:141](./spawn-placement.ts#L141) |
| spawn-placement | <code>STATION_DEFENCE_SPAN</code> | <code>2</code> | ...and the width of that draw: one or two of them. |  | [spawn-placement.ts:147](./spawn-placement.ts#L147) |
| spawn-placement | <code>STATION_DEFENCE_STANDOFF</code> | <code>500</code> | How far out of the slot the first one launches. |  | [spawn-placement.ts:153](./spawn-placement.ts#L153) |
| spawn-placement | <code>STATION_DEFENCE_STACK</code> | <code>120</code> | ...and how much further out each one after it starts, so a pair does not arrive inside each other. |  | [spawn-placement.ts:159](./spawn-placement.ts#L159) |
| spawn-placement | <code>STATION_DEFENCE_JITTER</code> | <code>80</code> | ...and the random nudge on each, so a second launch does not look like the first. |  | [spawn-placement.ts:169](./spawn-placement.ts#L169) |
...
| station | <code>DODO_TECH_LEVEL</code> | <code>10</code> | The tech level at which a system's station is the dodecahedral Dodo rather than the Coriolis, in SHOWN one-based units. |  | [station.ts:24](./station.ts#L24) |
| station | <code>BOUNCE_STANDOFF</code> | <code>420</code> | Where a fluffed docking bounces you to. |  | [station.ts:38](./station.ts#L38) |
| station | <code>LAUNCH_STANDOFF</code> | <code>450</code> | How far off the slot you sit when the bay spits you out, in world units. |  | [station.ts:41](./station.ts#L41) |
| station | <code>LAUNCH_SPEED</code> | <code>120</code> | ...and how fast, in world units a second — a firm push, not a cruise. |  | [station.ts:44](./station.ts#L44) |
| station | <code>DOCKED_BACKDROP_DISTANCE</code> | <code>900</code> | Where the docked menu parks your ship, along the slot normal, in world units. |  | [station.ts:51](./station.ts#L51) |
...
| sun | <code>SCOOP_RATE</code> | <code>5</code> | Tonnes of fuel gathered per second on a scoop — tenths of a light year. |  | [sun.ts:64](./sun.ts#L64) |
...
| tactic-choice | <code>TACTIC_MIN_DWELL</code> | <code>5</code> | The least time a ship keeps a tactic before it may take another. |  | [tactic-choice.ts:64](./tactic-choice.ts#L64) |
| tactic-choice | <code>TACTIC_SLEEPER_SECONDS</code> | <code>12</code> | How long a ship goes without a shot away before it concludes that whatever it does is not working. |  | [tactic-choice.ts:72](./tactic-choice.ts#L72) |
...
| threat-lock | <code>THREAT_MIN_HOLD</code> | <code>5</code> | Seconds that the defender fights a threat before it considers a rival. |  | [threat-lock.ts:15](./threat-lock.ts#L15) |
...
| witchspace | <code>THARGOID_AMBUSH_RANGE_SPAN</code> | <code>2500</code> | ...and the width of that band, so they do not all arrive at one distance. |  | [witchspace.ts:44](./witchspace.ts#L44) |
...
| world-clock | <code>MAX_STEPS_PER_FRAME</code> | <code>5</code> | ...and the most steps one frame may run, so a stall cannot spiral. |  | [world-clock.ts:29](./world-clock.ts#L29) |
| world-clock | <code>CARRY_LIMIT</code> | <code>3</code> | Unread taps of one key that the input carries across busy frames. |  | [world-clock.ts:37](./world-clock.ts#L37) |
...
| wreck | <code>MINING_YIELD_MIN</code> | <code>1</code> | Canisters of ore that a mined asteroid yields: at least the first one, plus a flat draw over the span. |  | [wreck.ts:35](./wreck.ts#L35) |
| wreck | <code>MINING_YIELD_SPAN</code> | <code>3</code> |  |  | [wreck.ts:36](./wreck.ts#L36) |
| wreck | <code>HERMIT_CONTRABAND_MIN</code> | <code>3</code> | Contraband canisters that a destroyed rock hermit scatters: a smuggler's den that spills its stock. |  | [wreck.ts:49](./wreck.ts#L49) |
| wreck | <code>HERMIT_CONTRABAND_SPAN</code> | <code>4</code> |  |  | [wreck.ts:50](./wreck.ts#L50) |
