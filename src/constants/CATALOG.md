...
390 exported constants. Regenerate with `npm run generate:constants`;
...
| combat-computer | <code>PURSUIT_BREAK_CLEARANCE</code> | <code>320</code> | How far to the side of the target a chaser aims on a break. |  | [combat-computer.ts:152](./combat-computer.ts#L152) |
| combat-computer | <code>PURSUIT_SLASH_CONE</code> | <code>1.3</code> | A pursuit PIRATE switches flight models on where it sits in the commander's arc. |  | [combat-computer.ts:174](./combat-computer.ts#L174) |
| combat-computer | <code>PURSUIT_HOLD_CONE</code> | <code>1.85</code> |  |  | [combat-computer.ts:175](./combat-computer.ts#L175) |
| combat-computer | <code>ENGAGED_CONE</code> | <code>0.6</code> | The nose-to-target angle, in radians, within which the co-pilot counts itself ENGAGED and will not switch targets. |  | [combat-computer.ts:184](./combat-computer.ts#L184) |
| combat-computer | <code>TARGET_DIST_WEIGHT</code> | <code>800</code> | How many world units of range weigh as much as one radian of off-nose turn. | <code>copilot.targetDistWeight</code> | [combat-computer.ts:202](./combat-computer.ts#L202) |
...
| encounters | <code>ANARCHY_GOVERNMENT</code> | <code>1</code> | ...and a government at or below THIS sends them two at a time: anarchy (0) and feudal (1). | <code>encounters.anarchyGovernment</code> | [encounters.ts:110](./encounters.ts#L110) |
| encounters | <code>MAX_THARGONS</code> | <code>4</code> | How many drones one Thargoid mothership keeps in the sky. |  | [encounters.ts:117](./encounters.ts#L117) |
| encounters | <code>THARGON_REDEPLOY</code> | <code>5</code> | Seconds between one drone and the next, and the wait for the first. | <code>encounters.thargonRedeploy</code> | [encounters.ts:132](./encounters.ts#L132) |
...
| law | <code>STATION_TRUCE</code> | <code>7000</code> | How close to the station the commander must be for the truce to hold. |  | [law.ts:85](./law.ts#L85) |
| law | <code>CONTRABAND</code> | <code>[3, 6, 10]</code> | The commodity indices that the Galactic Government defines as illegal: slaves, narcotics and firearms. |  | [law.ts:93](./law.ts#L93) |
| law | <code>OFFENDER_FINE</code> | <code>250</code> | The fine for a dock with a record, capped at what you can actually pay. |  | [law.ts:99](./law.ts#L99) |
| law | <code>FUGITIVE_FINE</code> | <code>750</code> |  |  | [law.ts:100](./law.ts#L100) |
| law | <code>KILLS_PER_RUNG</code> | <code>5</code> | Pirate kills that take a legal record down one rung. | <code>law.killsPerRung</code> | [law.ts:131](./law.ts#L131) |
| law | <code>DEFENCE_RANGE</code> | <code>9000</code> | Misbehave within this range of the station slot, and the Vipers launch. |  | [law.ts:139](./law.ts#L139) |
| law | <code>SCAN_RANGE</code> | <code>2600</code> | How close a police ship must be to scan your hold. |  | [law.ts:142](./law.ts#L142) |
| law | <code>SCAN_WARN_RANGE</code> | <code>4400</code> | A police ship this close is about to be able to read your hold, and the console says so while it stays there. |  | [law.ts:162](./law.ts#L162) |
| law | <code>SCAN_WARN_REPEAT</code> | <code>2</code> | Seconds between repeats of that warning, while a patrol stays in the band. | <code>law.scanWarnRepeat</code> | [law.ts:179](./law.ts#L179) |
| law | <code>BRIBE_SHARE</code> | <code>0.5</code> | What a policeman charges to not read your hold: this share of what the contraband aboard is worth at market. | <code>law.bribeShare</code> | [law.ts:208](./law.ts#L208) |
| law | <code>BRIBE_FLOOR</code> | <code>500</code> | ...but never less than this, so a light run is not a free pass. 50 Cr, in tenths of a credit (invariant 8). | <code>law.bribeFloor</code> | [law.ts:228](./law.ts#L228) |
| law | <code>PATROL_BRIBE_FINES</code> | <code>4</code> | What a police ship that already shoots at you charges to break off, as a multiple of the fine for the rung you are on. | <code>law.patrolBribeFines</code> | [law.ts:252](./law.ts#L252) |
| law | <code>BRIBE_REFUSED</code> | <code>0.35</code> | How often an HONEST commander's offer is refused and reported. | <code>law.bribeRefused</code> | [law.ts:284](./law.ts#L284) |
| law | <code>SCAN_LINE_SECONDS</code> | <code>4</code> | How long the scan's own line holds the console, and therefore how long the verdict that explains it waits behind it. | <code>law.scanLineSeconds</code> | [law.ts:299](./law.ts#L299) |
...
| player-gun | <code>ASSIST_FADE_START</code> | <code>900</code> |  |  | [player-gun.ts:138](./player-gun.ts#L138) |
| player-gun | <code>ASSIST_FADE_END</code> | <code>2400</code> |  |  | [player-gun.ts:139](./player-gun.ts#L139) |
...
| spawn-placement | <code>HUNTER_SCATTER</code> | <code>6000</code> | How far out a bounty hunter starts, at work on the whole system. |  | [spawn-placement.ts:81](./spawn-placement.ts#L81) |
| spawn-placement | <code>HERMIT_SCATTER</code> | <code>14_000</code> | How far out the rock hermit hides. |  | [spawn-placement.ts:88](./spawn-placement.ts#L88) |
| spawn-placement | <code>CORRIDOR_START</code> | <code>0.1</code> | Where along the route from you to the station the nearest pirate can be, as a fraction of that route. | <code>spawn.corridorStart</code> | [spawn-placement.ts:102](./spawn-placement.ts#L102) |
| spawn-placement | <code>CORRIDOR_SPAN</code> | <code>0.75</code> | How much of the route the rest are spread across. 0.1 + 0.75 leaves the last 15% clear, which is the approach to the station. |  | [spawn-placement.ts:108](./spawn-placement.ts#L108) |
| spawn-placement | <code>PIRATE_SCATTER</code> | <code>2500</code> | How far off the corridor's line each pirate sits. | <code>spawn.pirateScatter</code> | [spawn-placement.ts:121](./spawn-placement.ts#L121) |
| spawn-placement | <code>TRADER_ARRIVAL_RANGE</code> | <code>22_000</code> | How far out a fresh trader warps in. |  | [spawn-placement.ts:128](./spawn-placement.ts#L128) |
| spawn-placement | <code>DEEP_TRADER_RANGE</code> | <code>12_000</code> | How far AHEAD OF THE COMMANDER a trader warps in, out in deep space. | <code>spawn.deepTraderRange</code> | [spawn-placement.ts:141](./spawn-placement.ts#L141) |
| spawn-placement | <code>DEEP_TRADER_CONE</code> | <code>Math.asin(MASS_LOCK_SHIP / DEEP_TRADER_RANGE)</code> | The half-angle of the cone it warps into, about the commander's own heading, in RADIANS. 0.5 is about 29 degrees. | <code>spawn.deepTraderCone</code> | [spawn-placement.ts:168](./spawn-placement.ts#L168) |
| spawn-placement | <code>DEEP_TRADER_RUN</code> | <code>30_000</code> | How far it runs before it jumps out. |  | [spawn-placement.ts:179](./spawn-placement.ts#L179) |
| spawn-placement | <code>PIRATE_WAVE_RANGE</code> | <code>9000</code> | How far from the commander a pirate wave warps in. |  | [spawn-placement.ts:187](./spawn-placement.ts#L187) |
| spawn-placement | <code>PIRATE_WAVE_RANGE_SPAN</code> | <code>4000</code> | ...and how much further out than that they may be. |  | [spawn-placement.ts:190](./spawn-placement.ts#L190) |
| spawn-placement | <code>GENERATION_SHIP_RANGE</code> | <code>14_000</code> | How far from the commander a generation ship crosses. |  | [spawn-placement.ts:196](./spawn-placement.ts#L196) |
| spawn-placement | <code>GENERATION_SHIP_RANGE_SPAN</code> | <code>8000</code> | ...and the width of that band. |  | [spawn-placement.ts:199](./spawn-placement.ts#L199) |
| spawn-placement | <code>GENERATION_CARGO_SCATTER</code> | <code>700</code> | How far from a generation ship its shed cargo drifts. |  | [spawn-placement.ts:206](./spawn-placement.ts#L206) |
| spawn-placement | <code>MISSION_TARGET_RANGE</code> | <code>4000</code> | How far from the commander the Constrictor hides on the mission leg. |  | [spawn-placement.ts:212](./spawn-placement.ts#L212) |
| spawn-placement | <code>MISSION_TARGET_RANGE_SPAN</code> | <code>4000</code> | ...and the width of that band — the same again, so it can be twice as far. |  | [spawn-placement.ts:215](./spawn-placement.ts#L215) |
| spawn-placement | <code>THARGON_DEPLOY_RANGE</code> | <code>150</code> | How far from its mother a Thargon drone appears. |  | [spawn-placement.ts:221](./spawn-placement.ts#L221) |
| spawn-placement | <code>STATION_DEFENCE_MIN</code> | <code>1</code> | The fewest Vipers the station launches after you shoot at something you should not. | <code>spawn.stationDefenceMin</code> | [spawn-placement.ts:234](./spawn-placement.ts#L234) |
| spawn-placement | <code>STATION_DEFENCE_SPAN</code> | <code>2</code> | ...and the width of that draw: one or two of them. |  | [spawn-placement.ts:240](./spawn-placement.ts#L240) |
| spawn-placement | <code>STATION_DEFENCE_STANDOFF</code> | <code>500</code> | How far out of the slot the first one launches. |  | [spawn-placement.ts:246](./spawn-placement.ts#L246) |
| spawn-placement | <code>STATION_DEFENCE_STACK</code> | <code>120</code> | ...and how much further out each one after it starts, so a pair does not arrive inside each other. |  | [spawn-placement.ts:252](./spawn-placement.ts#L252) |
| spawn-placement | <code>STATION_DEFENCE_JITTER</code> | <code>80</code> | ...and the random nudge on each, so a second launch does not look like the first. |  | [spawn-placement.ts:262](./spawn-placement.ts#L262) |
