...
| spawn-placement | <code>ASTEROID_SCATTER</code> | <code>5000</code> | How far the rocks scatter. |  | [spawn-placement.ts:48](./spawn-placement.ts#L48) |
| spawn-placement | <code>ASTEROID_LANE_SCATTER</code> | <code>SCANNER_RANGE / 1.5</code> | How far off the arrival corridor each rock sits. |  | [spawn-placement.ts:66](./spawn-placement.ts#L66) |
| spawn-placement | <code>HUNTER_SCATTER</code> | <code>6000</code> | How far out a bounty hunter starts, at work on the whole system. |  | [spawn-placement.ts:74](./spawn-placement.ts#L74) |
| spawn-placement | <code>HERMIT_SCATTER</code> | <code>14_000</code> | How far out the rock hermit hides. |  | [spawn-placement.ts:81](./spawn-placement.ts#L81) |
| spawn-placement | <code>CORRIDOR_START</code> | <code>0.1</code> | Where along the route from you to the station the nearest pirate can be, as a fraction of that route. | <code>spawn.corridorStart</code> | [spawn-placement.ts:95](./spawn-placement.ts#L95) |
| spawn-placement | <code>CORRIDOR_SPAN</code> | <code>0.75</code> | How much of the route the rest are spread across. 0.1 + 0.75 leaves the last 15% clear, which is the approach to the station. |  | [spawn-placement.ts:101](./spawn-placement.ts#L101) |
| spawn-placement | <code>PIRATE_SCATTER</code> | <code>2500</code> | How far off the corridor's line each pirate sits. | <code>spawn.pirateScatter</code> | [spawn-placement.ts:114](./spawn-placement.ts#L114) |
| spawn-placement | <code>TRADER_ARRIVAL_RANGE</code> | <code>22_000</code> | How far out a fresh trader warps in. |  | [spawn-placement.ts:121](./spawn-placement.ts#L121) |
| spawn-placement | <code>DEEP_TRADER_RANGE</code> | <code>12_000</code> | How far AHEAD OF THE COMMANDER a trader warps in, out in deep space. | <code>spawn.deepTraderRange</code> | [spawn-placement.ts:134](./spawn-placement.ts#L134) |
| spawn-placement | <code>DEEP_TRADER_CONE</code> | <code>Math.asin(MASS_LOCK_SHIP / DEEP_TRADER_RANGE)</code> | The half-angle of the cone it warps into, about the commander's own heading, in RADIANS. 0.5 is about 29 degrees. | <code>spawn.deepTraderCone</code> | [spawn-placement.ts:161](./spawn-placement.ts#L161) |
| spawn-placement | <code>DEEP_TRADER_RUN</code> | <code>30_000</code> | How far it runs before it jumps out. |  | [spawn-placement.ts:172](./spawn-placement.ts#L172) |
| spawn-placement | <code>PIRATE_WAVE_RANGE</code> | <code>9000</code> | How far from the commander a pirate wave warps in. |  | [spawn-placement.ts:180](./spawn-placement.ts#L180) |
| spawn-placement | <code>PIRATE_WAVE_RANGE_SPAN</code> | <code>4000</code> | ...and how much further out than that they may be. |  | [spawn-placement.ts:183](./spawn-placement.ts#L183) |
| spawn-placement | <code>GENERATION_SHIP_RANGE</code> | <code>14_000</code> | How far from the commander a generation ship crosses. |  | [spawn-placement.ts:189](./spawn-placement.ts#L189) |
| spawn-placement | <code>GENERATION_SHIP_RANGE_SPAN</code> | <code>8000</code> | ...and the width of that band. |  | [spawn-placement.ts:192](./spawn-placement.ts#L192) |
| spawn-placement | <code>GENERATION_CARGO_SCATTER</code> | <code>700</code> | How far from a generation ship its shed cargo drifts. |  | [spawn-placement.ts:199](./spawn-placement.ts#L199) |
| spawn-placement | <code>MISSION_TARGET_RANGE</code> | <code>4000</code> | How far from the commander the Constrictor hides on the mission leg. |  | [spawn-placement.ts:205](./spawn-placement.ts#L205) |
| spawn-placement | <code>MISSION_TARGET_RANGE_SPAN</code> | <code>4000</code> | ...and the width of that band — the same again, so it can be twice as far. |  | [spawn-placement.ts:208](./spawn-placement.ts#L208) |
| spawn-placement | <code>THARGON_DEPLOY_RANGE</code> | <code>150</code> | How far from its mother a Thargon drone appears. |  | [spawn-placement.ts:214](./spawn-placement.ts#L214) |
| spawn-placement | <code>STATION_DEFENCE_MIN</code> | <code>1</code> | The fewest Vipers the station launches after you shoot at something you should not. |  | [spawn-placement.ts:222](./spawn-placement.ts#L222) |
| spawn-placement | <code>STATION_DEFENCE_SPAN</code> | <code>2</code> | ...and the width of that draw: one or two of them. |  | [spawn-placement.ts:228](./spawn-placement.ts#L228) |
| spawn-placement | <code>STATION_DEFENCE_STANDOFF</code> | <code>500</code> | How far out of the slot the first one launches. |  | [spawn-placement.ts:234](./spawn-placement.ts#L234) |
| spawn-placement | <code>STATION_DEFENCE_STACK</code> | <code>120</code> | ...and how much further out each one after it starts, so a pair does not arrive inside each other. |  | [spawn-placement.ts:240](./spawn-placement.ts#L240) |
| spawn-placement | <code>STATION_DEFENCE_JITTER</code> | <code>80</code> | ...and the random nudge on each, so a second launch does not look like the first. |  | [spawn-placement.ts:250](./spawn-placement.ts#L250) |
