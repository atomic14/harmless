...
383 exported constants. Regenerate with `npm run generate:constants`;
...
| encounters | <code>THARGON_REDEPLOY</code> | <code>5</code> | Seconds between one drone and the next, and the wait for the first. |  | [encounters.ts:120](./encounters.ts#L120) |
...
| law | <code>DEFENCE_RANGE</code> | <code>9000</code> | Misbehave within this range of the station slot, and the Vipers launch. |  | [law.ts:77](./law.ts#L77) |
| law | <code>SCAN_RANGE</code> | <code>2600</code> | How close a police ship must be to scan your hold. |  | [law.ts:80](./law.ts#L80) |
| law | <code>SCAN_WARN_RANGE</code> | <code>4400</code> | A police ship this close is about to be able to read your hold, and the console says so while it stays there. |  | [law.ts:100](./law.ts#L100) |
| law | <code>SCAN_WARN_REPEAT</code> | <code>2</code> | Seconds between repeats of that warning, while a patrol stays in the band. | <code>law.scanWarnRepeat</code> | [law.ts:117](./law.ts#L117) |
| law | <code>BRIBE_SHARE</code> | <code>0.5</code> | What a policeman charges to not read your hold: this share of what the contraband aboard is worth at market. | <code>law.bribeShare</code> | [law.ts:142](./law.ts#L142) |
| law | <code>BRIBE_FLOOR</code> | <code>500</code> | ...but never less than this, so a light run is not a free pass. 50 Cr, in tenths of a credit (invariant 8). | <code>law.bribeFloor</code> | [law.ts:162](./law.ts#L162) |
| law | <code>PATROL_BRIBE_FINES</code> | <code>4</code> | What a police ship that already shoots at you charges to break off, as a multiple of the fine for the rung you are on. | <code>law.patrolBribeFines</code> | [law.ts:186](./law.ts#L186) |
| law | <code>BRIBE_REFUSED</code> | <code>0.35</code> | How often an HONEST commander's offer is refused and reported. | <code>law.bribeRefused</code> | [law.ts:211](./law.ts#L211) |
| law | <code>SCAN_LINE_SECONDS</code> | <code>4</code> | How long the scan's own line holds the console, and therefore how long the verdict that explains it waits behind it. | <code>law.scanLineSeconds</code> | [law.ts:226](./law.ts#L226) |
...
| spawn-placement | <code>PIRATE_SCATTER</code> | <code>2500</code> | How far off the corridor's line each pirate sits. | <code>spawn.pirateScatter</code> | [spawn-placement.ts:91](./spawn-placement.ts#L91) |
| spawn-placement | <code>TRADER_ARRIVAL_RANGE</code> | <code>22_000</code> | How far out a fresh trader warps in. |  | [spawn-placement.ts:98](./spawn-placement.ts#L98) |
| spawn-placement | <code>PIRATE_WAVE_RANGE</code> | <code>9000</code> | How far from the commander a pirate wave warps in. |  | [spawn-placement.ts:106](./spawn-placement.ts#L106) |
| spawn-placement | <code>PIRATE_WAVE_RANGE_SPAN</code> | <code>4000</code> | ...and how much further out than that they may be. |  | [spawn-placement.ts:109](./spawn-placement.ts#L109) |
| spawn-placement | <code>GENERATION_SHIP_RANGE</code> | <code>14_000</code> | How far from the commander a generation ship crosses. |  | [spawn-placement.ts:115](./spawn-placement.ts#L115) |
| spawn-placement | <code>GENERATION_SHIP_RANGE_SPAN</code> | <code>8000</code> | ...and the width of that band. |  | [spawn-placement.ts:118](./spawn-placement.ts#L118) |
| spawn-placement | <code>GENERATION_CARGO_SCATTER</code> | <code>700</code> | How far from a generation ship its shed cargo drifts. |  | [spawn-placement.ts:125](./spawn-placement.ts#L125) |
| spawn-placement | <code>MISSION_TARGET_RANGE</code> | <code>4000</code> | How far from the commander the Constrictor hides on the mission leg. |  | [spawn-placement.ts:131](./spawn-placement.ts#L131) |
| spawn-placement | <code>MISSION_TARGET_RANGE_SPAN</code> | <code>4000</code> | ...and the width of that band — the same again, so it can be twice as far. |  | [spawn-placement.ts:134](./spawn-placement.ts#L134) |
| spawn-placement | <code>THARGON_DEPLOY_RANGE</code> | <code>150</code> | How far from its mother a Thargon drone appears. |  | [spawn-placement.ts:140](./spawn-placement.ts#L140) |
| spawn-placement | <code>STATION_DEFENCE_MIN</code> | <code>1</code> | The fewest Vipers the station launches when you have shot at something you should not have. |  | [spawn-placement.ts:148](./spawn-placement.ts#L148) |
| spawn-placement | <code>STATION_DEFENCE_SPAN</code> | <code>2</code> | ...and the width of that draw: one or two of them. |  | [spawn-placement.ts:154](./spawn-placement.ts#L154) |
| spawn-placement | <code>STATION_DEFENCE_STANDOFF</code> | <code>500</code> | How far out of the slot the first one launches. |  | [spawn-placement.ts:160](./spawn-placement.ts#L160) |
| spawn-placement | <code>STATION_DEFENCE_STACK</code> | <code>120</code> | ...and how much further out each one after it starts, so a pair does not arrive inside each other. |  | [spawn-placement.ts:166](./spawn-placement.ts#L166) |
| spawn-placement | <code>STATION_DEFENCE_JITTER</code> | <code>80</code> | ...and the random nudge on each, so a second launch does not look like the first. |  | [spawn-placement.ts:176](./spawn-placement.ts#L176) |
