...
| spawn-placement | <code>HERMIT_SCATTER</code> | <code>14_000</code> | How far out the rock hermit hides. |  | [spawn-placement.ts:95](./spawn-placement.ts#L95) |
| spawn-placement | <code>CORRIDOR_START</code> | <code>0.1</code> | Where along the route from you to the station the nearest pirate can be, as a fraction of that route. | <code>spawn.corridorStart</code> | [spawn-placement.ts:109](./spawn-placement.ts#L109) |
| spawn-placement | <code>CORRIDOR_SPAN</code> | <code>0.75</code> | How much of the route the rest are spread across. 0.1 + 0.75 leaves the last 15% clear, which is the approach to the station. |  | [spawn-placement.ts:115](./spawn-placement.ts#L115) |
| spawn-placement | <code>PIRATE_SCATTER</code> | <code>2500</code> | How far off the corridor's line each pirate sits. | <code>spawn.pirateScatter</code> | [spawn-placement.ts:128](./spawn-placement.ts#L128) |
