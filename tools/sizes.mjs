...
const ALLOWED = {
  ...
  'music-score.ts': "GENERATED: the docking waltz, one note per line — 1,051 of them across four instruments, converted from the arrangement Chris supplied. Its length is the arrangement's; the only way to shorten it is to lose notes or to pack several onto a line and lose the diff. The ENGINE that plays it is src/music.ts and is 200 lines; this is data, and splitting a score by track would put one piece of music in four files.",
