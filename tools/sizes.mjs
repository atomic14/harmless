...
const ALLOWED = {
  ...
  'game/game.ts': 'DEBT: 3,244 -> 2,528 -> 2,251 -> 2,153, and still the orchestrator plus leftovers. Target ~300. docs/TODO/150 is decomposing it a responsibility at a time, into children that sit beside the rules they spend — M1 took the law to game/law-actions.ts and M2 the sky to game/world-build.ts. The number here moves with each milestone, so the entry cannot go stale while the work is live.',
