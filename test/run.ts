...
import './mission-company.test.ts';
import './mission-arrival.test.ts';
import './scan-watch.test.ts';
import './mission-story.test.ts';
import './patrons.test.ts';
import './dossiers.test.ts';
import './tour.test.ts';
import './arcs.test.ts';
import './mission-pieces.test.ts';
import './tour-page.test.ts';
...
import './mission-courses.test.ts';
